 ...
 */
#ifndef MPS_CALCULATION_DEMUXPS_H
#define MPS_CALCULATION_DEMUXPS_H
...
class DemuxPS : public mps::core::FiFoSynchSourcePS
{
public:
    DemuxPS();
    virtual ~DemuxPS();
...
private:
    mps::core::RecordBuilder _inputRecord;

    const mps::core::Signal* _selSignal;
    Pt::uint32_t _selSource;
    Pt::uint32_t _selSigOffset;

    const mps::core::Signal* _inSignal;
    Pt::uint32_t _inSource;
    Pt::uint32_t _inSigOffset;
