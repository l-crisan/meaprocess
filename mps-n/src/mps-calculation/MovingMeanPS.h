 ...
 */
#ifndef MPS_CALCULATION_MOVINGMEANPS_H
#define MPS_CALCULATION_MOVINGMEANPS_H
...
class MovingMeanPS : public mps::core::FiFoSynchSourcePS
{
public:
    MovingMeanPS();
    virtual ~MovingMeanPS();
...
private:
    ...
    struct OutSigInfo
    {
        ...
        const MovingMeanSignal* outSignal;
    };
