...
bool SocketCANDriver::open(const std::string& deviceID, Pt::uint8_t deviceNo, Pt::uint8_t port, Pt::uint32_t bitRate, bool extendedID)
{
    ...
    if( impl == 0 )
    {
        impl.reset( new SocketCANDriverImpl());
