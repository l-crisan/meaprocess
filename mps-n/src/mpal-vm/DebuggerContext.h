 ...
 */
#ifndef MPAL_VM_DEBUGGERCONTEXT_H
#define MPAL_VM_DEBUGGERCONTEXT_H
...
class DebuggerContext : public VMContext
{
public: 
    DebuggerContext(Pt::uint8_t* stackPtr_, Pt::uint8_t* basePtr_,Pt::uint8_t* baseAdr_, Pt::uint32_t stackSize, Pt::System::Mutex& breakPointMutex_, std::vector<BreakPoint>& breakPoints_,
