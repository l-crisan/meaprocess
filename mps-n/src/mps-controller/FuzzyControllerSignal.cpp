...
FuzzyControllerSignal::FuzzyControllerSignal(Pt::uint32_t id)
: Signal(id)
, _inputLingVars(0)
{
}

FuzzyControllerSignal::~FuzzyControllerSignal()
{
    if( _inputLingVars != 0)
    {
...
void FuzzyControllerSignal::addObject(Object* obj, const std::string& type, const std::string& subType)
{
