 ...
 */
#ifndef MPS_STATISTICS_MINIMAMAXIMAPS_H
#define MPS_STATISTICS_MINIMAMAXIMAPS_H
...
class MinimaMaximaPS : public mps::core::FiFoSynchSourcePS
{
public:
    MinimaMaximaPS();
    virtual ~MinimaMaximaPS();
...
private:
    struct OutSigInfo
    {
        double lastValues1;
        double lastValues2;
        const MinimaMaximaSignal* outSignal;
        double outValue;
    };
