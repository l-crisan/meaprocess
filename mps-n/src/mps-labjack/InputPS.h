 ...
 */
#ifndef MPS_LABJACK_INPUTPS_H
#define MPS_LABJACK_INPUTPS_H
...
class InputPS : public mps::core::FiFoSynchSourcePS
{
public:
    InputPS(void);

    virtual ~InputPS(void);
