 ...
 */
#ifndef MPS_IIRFILTER_CHEBYSHEVCOEF_H
#define MPS_IIRFILTER_CHEBYSHEVCOEF_H
...
{
public:
    ChebyshevCoef(Pt::uint32_t order, double sampleFrequency, double lowerFrequnecy, double upperFrequency, double delta, double stopRipple);
