 ...
 */
#ifndef MPS_IIRFILTER_BUTTERWORTHCOEF_H
#define MPS_IIRFILTER_BUTTERWORTHCOEF_H
...
class ButterworthCoef
{
public:
    ButterworthCoef(Pt::uint32_t order, double sampleFrequency,double lowerFrequnecy, double upperFrequency, double delta, double stopRipple);
...
private:
    ...
    double analog_fs;
    double analog_omega;
    double pb_1, pb_2, sb_1, sb_2, c_bp, c_bs;
    bool lp_flag;
    bool hp_flag;
    bool bp_flag;
    bool bs_flag;    
