 ...
 */
#ifndef MPS_CLOCK_CLOCKPS_H
#define MPS_CLOCK_CLOCKPS_H
...
class ClockPS : public mps::core::SynchSourcePS
{
public:
    ClockPS();
    virtual ~ClockPS();

    inline Pt::uint8_t time() const
    {
        return _time;
    }

    inline void setTime(Pt::uint8_t t)
    {
        _time = t;
    }
protected:
