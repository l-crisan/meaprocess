 ...
 */
#ifndef MPS_CORE_OBJECTVECTOR_H
#define MPS_CORE_OBJECTVECTOR_H
...
/**@brief A reflectale vector derivated from vector and from Object.*/
template<class T>
...
public:	
    ...
    { 
         std::vector<T>::push_back( (T) object ); 
    }
};
