 ...
 */
#ifndef MPS_FILTER_API_H
#define MPS_FILTER_API_H

#include <Pt/Api.h>
#include <Pt/Types.h>

#if defined(MPS_FILTER_EXPORTS)
#  define MPS_FILTER_API PT_EXPORT
#else
#  define MPS_FILTER_API PT_IMPORT
#endif

extern "C"
{  

const int FTypeButterworth = 0;
const int FTypeChebyshev = 1;
const int FTypeBessel = 2;
const int FTypeElliptic = 3;
