...
#ifndef Pt_Json_EndDocument_h
#define Pt_Json_EndDocument_h
...
/** @brief Represents the end of an JSON document.
    
    The last node which is read from a document is the EndDocument node.
    It is reported after all JSON elements in were parsed, similar to an
