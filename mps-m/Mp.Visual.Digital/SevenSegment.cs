...
namespace Mp.Visual.Digital
{
    public class SevenSegment : UserControl
    {
        ...
        {
            gridHeight = this.Height - elementWidth;
        ...
        private void SevenSegment_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (showDot)
                e.Graphics.FillEllipse(dotOn ? brushLight : brushDark, gridWidth - elementWidth / 2, gridHeight - elementWidth -elementWidth / 2, elementWidth / 2, elementWidth / 2);
