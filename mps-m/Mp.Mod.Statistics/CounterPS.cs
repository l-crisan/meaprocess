...
{
    internal class CounterPS : WorkPS
    {
        public CounterPS()
        {
            base.Type = "Mp.Stat.PS.Count";
            base.Text = StringResource.Counter;
            base.Group = StringResource.Statistics;
            base.Symbol = Mp.Mod.Statistics.Resource.CounterImg;
            base.Icon = Mp.Mod.Statistics.Resource.CounterIcon;
        ...
        public override string Description
        {
            get
            {
                return StringResource.CounterDescription;
            }
        }
        ...
        {
            Document.ShowHelp(this.Site, 1540);
        }

        protected override void OnProperties(object sender, EventArgs e)
        {
            CounterDlg dlg = new CounterDlg(XmlRep, Document, InputPorts[0].SignalList, OutputPorts[0].SignalList);
