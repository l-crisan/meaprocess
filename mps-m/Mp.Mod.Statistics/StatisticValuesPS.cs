...
{
    internal class StatisticValuesPS : WorkPS
    {
        public StatisticValuesPS()
        {
            base.Type = "Mp.Stat.PS.StatValue";
            base.Text = StringResource.StatisticValues;
            base.Group = StringResource.Statistics;
            base.Symbol = Mp.Mod.Statistics.Resource.StatisticValuesImg;
            base.Icon = Mp.Mod.Statistics.Resource.StatisticValuesIcon;
        ...
        public override void OnDefaultInit()
        {
            ...
            XmlHelper.SetParamNumber(XmlRep, "samples", "uint32_t", 10);
        }
        ...
        public override string Description
        {
            get
            {
                return StringResource.StatisticValuesDescription;
            }
        }
        ...
        {
            StatisticValuesPortDlg dlg = new StatisticValuesPortDlg(Document, XmlRep, OutputPorts[0].SignalList);
            dlg.ShowDialog();
        }
        ...
        {
            Document.ShowHelp(this.Site, 1530);
        }

        protected override void OnProperties(object sender, EventArgs e)
        {
            StatisticValuesDlg dlg = new StatisticValuesDlg(Document, XmlRep);
