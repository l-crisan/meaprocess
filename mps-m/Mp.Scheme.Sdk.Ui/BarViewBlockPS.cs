...
{
    public class BarViewBlockPS : VisualBlockPS
    {
        private Assembly _myControlsAssembly;

        public BarViewBlockPS()
        {
            ...
            base.SubType = "Mp.Runtime.Sdk.BarViewBlockPS";
        ...
        protected override void OnInitControl()
        {
            ...
            ctrlData.PropertyFilter.Add("BarBackColor");
            ctrlData.PropertyFilter.Add("BarBorderStyle");
            ctrlData.PropertyFilter.Add("Value");
           

            BlockView.Tag = ctrlData;
