...
{
    public class DigitalMeter7SegBlockPS : VisualBlockPS
    {
        private Assembly _myControlsAssembly;

        public DigitalMeter7SegBlockPS()
        {
            ...
            base.SubType = "Mp.Runtime.Sdk.DigitalMeter7SegBlockPS";
        ...
        {
            base.BlockView = new DigitalMeter3Block();
