...
{
    public class RuntimeOptTool : Mp.Scheme.Sdk.Tool
    {
        ...
        public override void OnLoadDocument(Mp.Scheme.Sdk.Document doc, Mp.Visual.Docking.DockPanel dockPanel, Form mainFrame)
        {
            _doc = doc;
