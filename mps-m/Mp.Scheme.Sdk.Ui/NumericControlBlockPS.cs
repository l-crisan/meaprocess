...
{
    public class NumericControlBlockPS : VisualBlockPS
    {
        ...
        public NumericControlBlockPS()
        {
            ...
            base.SubType = "Mp.Runtime.Sdk.NumericControlBlockPS";
        ...
        {
            base.BlockView = new DigitalMeter1Block();
