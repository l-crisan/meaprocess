...
{
    public class InputButtonPS : VisualPS
    {
        ...
        public InputButtonPS()
        {
            ...
            base.Symbol = Images.InputButton;
            base.Icon = Images.ButtonIcon;
        ...
        public override void OnDefaultInit()
        {
            ...
            Mp.Visual.Digital.RoundButton button = new Mp.Visual.Digital.RoundButton();
            button.Tag = ctrlData;
        ...
        {
            Document.ShowHelp(this.Site, 760);
        }
    }
}
