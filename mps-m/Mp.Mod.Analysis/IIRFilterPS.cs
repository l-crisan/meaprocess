...
{
    internal class IIRFilterPS : WorkPS
    {
        public IIRFilterPS()
        {
            base.Type = "Mp.Analysis.PS.IIRFiler";
            base.Text = StringResource.Filter;
            base.Group = StringResource.Analysis;
            base.Symbol = Resource.Filter;
            base.Icon = Resource.FilterIcon;
        ...
        public override string Description
        {
            get
            {
                return StringResource.IIRFilterPsDescription;
            }
        }
        ...
        {
            Document.ShowHelp(this.Site,990);    
        }

        protected override void OnProperties(object sender, EventArgs e)
        {
            IIRFilterDlg dlg = new IIRFilterDlg(Document, XmlRep);
