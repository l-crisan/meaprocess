...
{
    public partial class MultiplexerDlg : Form
    {
        ...
        public MultiplexerDlg(XmlElement xmlPS, Document doc, XmlElement xmlInSignalList)
        {
            _xmlPS = xmlPS;
            _doc = doc;
            ...
            FormStateHandler.Restore(this, "Mp.Calculation.MultiplexerDlg");
        }
        ...
        private void removeSignalToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            signals.Items.Remove(signals.SelectedItems[0]);
        }
