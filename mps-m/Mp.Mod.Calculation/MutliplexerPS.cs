...
{
    internal class MultiplexerPS : WorkPS
    {
        public MultiplexerPS()
        {
            base.Type = "Mp.Calculation.PS.Mux";
            base.Text = StringResource.Multiplexer;
            base.Group = StringResource.Calculation;
            base.Symbol = Resource.MultiplexerImg;
            base.Icon = Resource.MultiplexerIcon;
        ...
        public override string Description
        {
            get
            {
                return StringResource.MuxDescription;
            }
        }
        ...
        {
            Document.ShowHelp(this.Site, 1450);
        }
        ...
        {
            MultiplexerDlg dlg = new MultiplexerDlg(XmlRep, Document, InputPorts[0].SignalList);
