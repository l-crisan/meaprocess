...
{
    internal class BitExtractionPS : WorkPS
    {
        public BitExtractionPS()
        {
            base.Type = "Mp.Calculation.PS.BitEx";
            base.Text = StringResource.BitExtraction;
            base.Group = StringResource.Calculation;
            base.Symbol = Resource.BitExtractionImg;
            base.Icon = Resource.BitExtractionIcon;
        ...
        public override string Description
        {
            get
            {
                return StringResource.BitExtractionDescription;
            }
        }
        ...
        {
            BitExtractionDlg dlg = new BitExtractionDlg(XmlRep, Document, InputPorts[0].SignalList, OutputPorts[0].SignalList);

            if (dlg.ShowDialog() == DialogResult.OK)
            {
                base.Text = XmlHelper.GetParam(XmlRep, "name");
        ...
        {
            Document.ShowHelp(this.Site, 1470);
        }
