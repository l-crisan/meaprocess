...
{
    internal class BitGroupingPS : WorkPS
    {
        public BitGroupingPS()
        {
            base.Type = "Mp.Calculation.PS.BitGrp";
            base.Text = StringResource.BitGrouping;
            base.Group = StringResource.Calculation;
            base.Symbol = Resource.BitGroupingImg;
            base.Icon = Resource.BitGroupingIcon;
        ...
        public override string Description
        {
            get
            {
                return StringResource.BitGroupingDescr;
            }
        }
        ...
        protected override void OnDocumentChanged()
        {
            ...
            XmlElement xmlOutSig = (XmlElement) OutputPorts[0].SignalList.ChildNodes[0];

            if(port.SignalList == null)
            {
                XmlHelper.SetParam(xmlOutSig, "sigMapping", "string","");
                return;
            }

            string sigMapping = XmlHelper.GetParam(xmlOutSig, "sigMapping");
            ...
            foreach (string str in array)
            {
                ...
                string[] id2Sig = str.Split(',');

                uint sigId = Convert.ToUInt32(id2Sig[0]);
            ...
            XmlHelper.SetParam(XmlRep, "sigMapping", "string", newSigList);
        }
        ...
        {
            Document.ShowHelp(this.Site, 1480);
        }
     
        protected override void OnProperties(object sender, EventArgs e)
        {
            BitGroupingDlg dlg = new BitGroupingDlg(Document, XmlRep, InputPorts[0].SignalList, OutputPorts[0].SignalList);
