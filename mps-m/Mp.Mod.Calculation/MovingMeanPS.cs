...
{
    internal class MovingMeanPS : WorkPS
    {
        public MovingMeanPS()
        {
            base.Type = "Mp.Calculation.PS.MovingMean";
            base.Text = StringResource.MovingMean;
            base.Group = StringResource.Calculation;
            base.Symbol = Resource.MovingMeanImg;
            base.Icon = Resource.MovingMeanIcon;
        ...
        public override string Description
        {
            get
            {
                return StringResource.MovingMeanDescription;
            }
        }
        ...
        {
            Document.ShowHelp(this.Site, 1410);
        }

        protected override void OnProperties(object sender, EventArgs e)
        {
            MovingMeanDlg dlg = new MovingMeanDlg(XmlRep, Document, InputPorts[0].SignalList, OutputPorts[0].SignalList);
