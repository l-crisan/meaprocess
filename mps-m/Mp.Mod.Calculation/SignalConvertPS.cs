...
{
    internal class SignalConvertPS : WorkPS
    {
        public SignalConvertPS()
        {
            base.Type = "Mp.Calculation.PS.SignalConvert";
            base.Text = StringResource.Convert;
            base.Group = StringResource.Calculation;
            base.Symbol = Resource.SignalConvertImg;
            base.Icon = Resource.SignalConvertIcon;
        ...
        private void InitMenuForPort(Port port)
        {
            ...
            menuItem.Font = new System.Drawing.Font("Tahoma", 8.25F, FontStyle.Bold);
        ...
        protected override void OnDocumentChanged()
        {
            ...
            for (int i = 0; i < OutputPorts[0].SignalList.ChildNodes.Count; ++i)
            {
                ...
                uint sigId = (uint)XmlHelper.GetParamNumber(xmlDelaySignal, "fromSignal");
        ...
        {
            SignalConvertPSDlg dlg = new SignalConvertPSDlg(XmlRep, Document, InputPorts[0].SignalList, OutputPorts[0].SignalList);
