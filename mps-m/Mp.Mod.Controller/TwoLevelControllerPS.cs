...
{
    internal class TwoLevelControllerPS : WorkPS
    {
        public TwoLevelControllerPS()
        {
            base.Type = "Mp.Controller.PS.TwoLevelCtrl";
            base.Text = StringResource.TwoLevelController;
            base.Group = StringResource.AutomaticControl;
            base.Symbol = Mp.Mod.Controller.Resource.TwoPointControllerImg;
            base.Icon = Mp.Mod.Controller.Resource.TwoPointController;
        ...
        public override string Description
        {
            get
            {
                return StringResource.TwoLevelControllerDscr;
            }
        }
        ...
        protected void OnPropertyDataPort(object sender, EventArgs e)
        {
            ...
            TwoPointPortDlg dlg = new TwoPointPortDlg(Document, XmlRep, port.SignalList);
            dlg.ShowDialog();
        }

        public override void OnHelpRequested()
        {
            Document.ShowHelp(this.Site, 1570);
        }

        protected override void OnProperties(object sender, EventArgs e)
        {
            TwoPointPSDlg dlg = new TwoPointPSDlg(Document, XmlRep, OutputPorts[0].SignalList);
