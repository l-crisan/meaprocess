...
{
    internal class ThreeStepControllerPS : WorkPS
    {
        public ThreeStepControllerPS()
        {
            base.Type = "Mp.Controller.PS.ThreeLevelCtrl";
            base.Text = StringResource.ThreeStepController;
            base.Group = StringResource.AutomaticControl;
            base.Symbol = Mp.Mod.Controller.Resource.ThreeStepControllerImg;
            base.Icon = Mp.Mod.Controller.Resource.ThreeStepController;
        ...
        public override string Description
        {
            get
            {
                return StringResource.ThreeStepControllerDescrp;
            }
        }
        ...
        protected void OnPropertyDataPort(object sender, EventArgs e)
        {
            ...
            ThreeStepPortDlg dlg = new ThreeStepPortDlg(Document, XmlRep, port.SignalList);
            dlg.ShowDialog();
        }

        public override void OnHelpRequested()
        {
            Document.ShowHelp(this.Site, 1580);
        }

        protected override void OnProperties(object sender, EventArgs e)
        {
            ThreeStepPSDlg dlg = new ThreeStepPSDlg(Document, XmlRep, OutputPorts[0].SignalList);
