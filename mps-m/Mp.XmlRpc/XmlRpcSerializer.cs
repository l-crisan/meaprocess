namespace Mp.XmlRpc
{
  ...
  class XmlRpcSerializer : XmlRpcXmlTokens
  {
    ...
    {
        throw new Exception("Int64 unsupported data type");
    }
    ...
    else if (obj is Double)
    {
        ...
        output.WriteElementString(DOUBLE, Convert.ToString(v, info));
    }
    else if (obj is Boolean)
    {
        output.WriteElementString(BOOLEAN, ((((Boolean)obj) == true) ? "true" : "false"));
    }
