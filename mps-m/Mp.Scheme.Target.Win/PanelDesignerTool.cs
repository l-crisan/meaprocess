...
{
    internal class PanelDesignerTool: Tool
    {
        private Document _document;
        private MainFrame _designer;
        private DockPanel _dockPanel;

        public PanelDesignerTool()
        {
            _designer = new MainFrame();
            //base.Icon        = Mp.Scheme.Win.Images.GUIDesigner;
            base.Name        = "";
            //base.ToolTip     = "Show the panel designer";
            //base.Shortcut    = ((System.Windows.Forms.Keys)((System.Windows.Forms.Keys.Control | System.Windows.Forms.Keys.D)));
        }
        ...
        public override void OnLoadDocument(Document document, DockPanel dockPanel, Form mainFrame)
        {
            ...
            _designer.AppendControl += new AppendControl(OnAppendControl);
