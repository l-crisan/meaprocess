...
{
    internal class ComboBoxPS : ProcessStation
    {
        private Mp.Visual.Digital.ComboBox _comboBox;
        ...
        {
            _comboBox = (Visual.Digital.ComboBox)Controls[0];
            _comboBox.UpdateView();
        }
    }
}
