...
{
    public class ManometerBlockPS : VisualBlockPS
    {
        public ManometerBlockPS()
        {
        }
        ...
        protected override Control OnCreateControl(Signal signal)
        {
            ...
            ctrl.TextUnit = signal.Unit;
            ctrl.Text = signal.Name;
            ctrl.Min = (float)signal.Minimum;
            ctrl.Max = (float)signal.Maximum;
        ...
        {
            Manometer ctrl = (Manometer)control;
