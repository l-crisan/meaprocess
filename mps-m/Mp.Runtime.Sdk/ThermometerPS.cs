...
{
    internal class ThermometerPS : SignalBasedPS
    {
        ...
        {
            foreach (Thermometer control in Controls)
                control.Value = 0.0;
        ...
        {
            Thermometer ctrl = (Thermometer)control;
            ctrl.Value = value;
        }
        ...
        protected override void OnSetupTheControls()
        {
            ...
            {
                control = (Thermometer)Controls[i];
                signal = GetSignalForControl(control);
                control.Text = signal.Name;
            }
        }
    }
}
