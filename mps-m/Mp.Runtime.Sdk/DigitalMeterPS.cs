...
{
    internal class DigitalMeterPS : SignalBasedPS
    {
        ...
        {
            foreach (DigitalMeter2 control in Controls)
                control.Value = 0.0;
        ...
        {
            DigitalMeter2 numCtrl = (DigitalMeter2)control;
            numCtrl.Value = value;
        }
        ...
        protected override void OnSetupTheControls()
        {
            ...
            DigitalMeter2 control;
            Signal signal;
            //Setup the unit and the label.
            for (int i = 0; i < Controls.Count; i++)
            {
                control = (DigitalMeter2)Controls[i];
                signal = GetSignalForControl(control);
                control.Unit = signal.Unit;
