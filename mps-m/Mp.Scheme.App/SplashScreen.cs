            ...
            if ( Bounds.Width > 0 && Bounds.Height > 0 && Visible )
            {
                try
                {
                    ...
                    if (TitleString != string.Empty)
                    {
                        ...
                        RectangleF rectangleF = new RectangleF(ClientRectangle.Left + ClientRectangle.Width / 2 - sizeF.Width/2, ClientRectangle.Top + m_nTextOffsetY, sizeF.Width, sizeF.Height);
